...
var Salam = React.createClass({displayName: "Salam",

  render: function(){
    return React.createElement("span", null, this.props.text, " ", React.createElement("b", null, this.props.to));
  }
...
// render
React.render(React.createElement(Salam, {text: "Selamat Siang", to: "Azam"}), document.body);

},{"./Salam.react":1,"react":157}],3:[function(require,module,exports){
/**
